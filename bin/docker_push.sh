...
if [[ "$1" == "local" ]]; then
    ...
    export SCORES=test-driven-scores
    export SCORES_REPO=${MAIN_REPO}#${TRAVIS_BRANCH}:services/scores
    export SCORES_DB=test-driven-scores_db
    export SCORES_DB_REPO=${MAIN_REPO}#${TRAVIS_BRANCH}:services/scores/project/db
